...
insert into products (name, description, code, price, Rating_Product, Storage_ID, Brand_ID,   Category_ID) 
  ...
  values ('RTX 4090', 'De GIGABYTE GeForce RTX 4090 Gaming OC 24G is uitgerust met een krachtige grafische processor en ultrasnel GDDR6X grafisch geheugen.', '816905633-0', 1959.00, 5, 2, 1, 1);


insert into products (name, description, code, price, Rating_Product, Storage_ID, Brand_ID, Category_ID) 
  
  values ('RTX 4080', 'De MSI GeForce RTX 4080 16GB GAMING X TRIO is een high-end grafische kaart, gebaseerd op de NVIDIA GeForce RTX 4080 Chip en beschikt over 16 GB GDDR6X geheugen dat via een 256 bit brede interface aangesproken wordt.', '077030122-3', 1489.00, 3, 4, 1, 1);


insert into products (name, description, code, price, Rating_Product, Storage_ID, Brand_ID, Category_ID) 
  
  values ('AMD Ryzen 7 5600X 3D', 'De nieuwe snelle Ryzen 5 serie neemt het op tegen de 12e generatie van Intel. Met de 5600X processor beschikt de processor over de nieuwe AMD Zen 3 architectuur en de Vermeer chip, waardoor de processor nog sneller is en meer cache heeft dan zijn voorgangers!', '445924201-X', 330.00, 4, 1, 2, 2);
...
insert into products (name, description, code, price, Rating_Product, Storage_ID, Brand_ID, Category_ID) 
  ...
  values ('ASUS ROG STRIX B650E-F GAMING WIFI', 'Aller nieuwste! ', '686928463-6', 14, 4, 2, 3, 4);


insert into products (name, description, code, price, Rating_Product, Storage_ID, Brand_ID, Category_ID) 
  
  values ('Asus ROG STRIX B550-F GAMING', 'Een dikke verbetering!  ', '492662523-7', 14, 2, 3, 3, 4);


insert into products (name, description, code, price, Rating_Product, Storage_ID, Brand_ID, Category_ID)
  
  values ('Asrock Intel Arc A770', 'De A770 is de de hoger gepositioneerde desktopvideokaart in Intels eerste generatie Arc-GPUs. Met 8 GB aan GDDR6 geheugen met een snelheid van 16 Gbps is geen taak te moeilijk voor de A770.', '492662523-7', 14, 3, 4, 1, 1);

insert into products (name, description, code, price, Rating_Product, Storage_ID, Brand_ID, Category_ID) 
  
  values ('Asrock Intel Arc A380', 'Perfect voor een beginner. ', '492662523-7', 14, 3.5, 1, 4, 3);
